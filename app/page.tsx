      ...
      <footer className="bg-slate-900 text-white py-12 border-t border-slate-800">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="text-xl font-bold">DimensionareGAZE</h3>
              </div>
            ...
            {/* Contact */}
            <div>
              <h4 className="font-semibold text-white mb-4">Contact Direct</h4>
              <div className="space-y-3">
                ...
                <p className="text-slate-400 text-sm">
                  Răspuns garantat în 24h prin formularul de contact
                </p>
              </div>
            </div>
          ...
          <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-slate-400 text-sm">
              © {new Date().getFullYear()} DimensionareGAZE - Șutac Ion. Toate drepturile rezervate.
            </p>
